...
public func genWitnessWrapper(inputJson: String, compiledCircuitPath: String, vkPath: String, srsPath: String) async throws -> String {
    return
        try await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_ios_ezkl_fn_func_gen_witness_wrapper(FfiConverterString.lower(inputJson), FfiConverterString.lower(compiledCircuitPath), FfiConverterString.lower(vkPath), FfiConverterString.lower(srsPath))
            },
 ...
 */
public func proveAdvancedWrapper(witnessJson: String, compiledCircuitPath: String, pkPath: String, srsPath: String?, proofType: ProofTypeWrapper, checkMode: CheckModeWrapper) throws -> String {
    return try FfiConverterString.lift(rustCallWithError(FfiConverterTypeEZKLError.lift) {
        uniffi_ios_ezkl_fn_func_prove_advanced_wrapper(
            ...
            FfiConverterString.lower(compiledCircuitPath),
 ...
 */
public func proveWrapper(witnessJson: String, compiledCircuitPath: String, pkPath: String, srsPath: String?) throws -> String {
    return try FfiConverterString.lift(rustCallWithError(FfiConverterTypeEZKLError.lift) {
        uniffi_ios_ezkl_fn_func_prove_wrapper(
            FfiConverterString.lower(witnessJson),
            FfiConverterString.lower(compiledCircuitPath),
            FfiConverterString.lower(pkPath),
            FfiConverterOptionString.lower(srsPath), $0
        )
    })
}

public func verifyWrapper(proofJson: String, settingsPath: String, vkPath: String, srsPath: String?) throws -> Bool {
    return try FfiConverterBool.lift(rustCallWithError(FfiConverterTypeEZKLError.lift) {
        uniffi_ios_ezkl_fn_func_verify_wrapper(
            ...
            FfiConverterString.lower(settingsPath),
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_ios_ezkl_checksum_func_gen_witness_wrapper() != 65081 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ios_ezkl_checksum_func_prove_advanced_wrapper() != 60411 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ios_ezkl_checksum_func_prove_wrapper() != 52879 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ios_ezkl_checksum_func_verify_wrapper() != 51016 {
        return InitializationResult.apiChecksumMismatch
    }
